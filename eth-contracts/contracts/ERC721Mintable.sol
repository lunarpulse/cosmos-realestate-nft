...
//    @dev Approves another address to transfer the given token ID
    function approve(address target, uint256 tokenId) public {
        ...
        require(owner != target, "Token already owned by the the target  address");
        require(owner == msg.sender || isApprovedForAll(owner, msg.sender), "The sender must be approved or owner" );
